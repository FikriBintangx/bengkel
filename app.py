...
INDONESIAN_SYNONYMS_MULTI = {
    ...
    "membantu":        ["mempermudah", "mendukung", "memfasilitasi"],
    "mempermudah":     ["membantu", "mendukung", "memfasilitasi"],
    ...
    "mendukung":       ["menunjang", "membantu", "memfasilitasi"],
    "menunjang":       ["mendukung", "membantu", "memfasilitasi"],
    # Nomina
    ...
    "mampu":           ["dapat", "bisa", "sanggup"],
    "analisis":        ["kajian", "telaah", "evaluasi", "penilaian"],
    "kajian":          ["analisis", "telaah", "evaluasi"],
    "telaah":          ["analisis", "kajian", "evaluasi"],
    "evaluasi":        ["analisis", "kajian", "penilaian"],
    ...
    "tentang":         ["mengenai", "terkait", "perihal"],
    "mengenai":        ["tentang", "terkait", "perihal"],
    "terkait":         ["tentang", "mengenai", "perihal"],
    "perihal":         ["tentang", "mengenai", "terkait"],
    ...
    "kesalahan":       ["kekeliruan", "error", "galat"],
    "kekeliruan":      ["kesalahan", "error", "galat"],
    "data":            ["informasi", "rekaman", "catatan"],
    "informasi":       ["data", "keterangan", "rekaman"],
    "pengguna":        ["pemakai", "user", "pengguna akhir"],
    "pemakai":         ["pengguna", "user"],
    "kinerja":         ["performa", "unjuk kerja", "prestasi"],
    "performa":        ["kinerja", "unjuk kerja", "prestasi"],
    "laporan":         ["rekap", "dokumen", "catatan"],
    "rekap":           ["laporan", "dokumen", "catatan"],
    "masalah":         ["permasalahan", "kendala", "hambatan"],
    "permasalahan":    ["masalah", "kendala", "hambatan"],
    "kendala":         ["masalah", "permasalahan", "hambatan"],
    "hambatan":        ["masalah", "kendala", "permasalahan"],
    "hasil":           ["temuan", "luaran", "keluaran"],
    "temuan":          ["hasil", "luaran", "keluaran"],
    "luaran":          ["hasil", "temuan", "keluaran"],
    ...
    "pengelolaan":     ["manajemen", "administrasi", "pengaturan"],
    "manajemen":       ["pengelolaan", "administrasi", "pengaturan"],
    "administrasi":    ["pengelolaan", "manajemen", "pengaturan"],
    "kebutuhan":       ["keperluan", "persyaratan", "tuntutan"],
    "keperluan":       ["kebutuhan", "persyaratan", "tuntutan"],
...
def offline_paraphrase(text):
    ...
    for sentence in sentences:
        ...
        # Ganti sinonim kata per kata (HANYA kata lengkap, case-aware, randomized)
        def replace_word(m):
            word = m.group(0)
            lower = word.lower()
            syn = _get_synonym(lower)
            if syn == lower:
                return word  # tidak ada sinonim, kembalikan asli
